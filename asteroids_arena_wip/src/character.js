function Character() {
    // TODO (maybe?) make Character a base class? (or.. maybe not? it might make more sense to do that in a language like C++, where you need a base-class pointer to an object of a subclass)
