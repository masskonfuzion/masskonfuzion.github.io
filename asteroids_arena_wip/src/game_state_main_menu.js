function GameStateMainMenu() {
    ...
    //this.uiItems.push( {"text": "Play Game", "posNDC": [0.5, 0.5], "align": "center"} );    // TODO delete
    ...
    this.uiItems.push( new uiItemText("How to Play", "32px", "MenuFont", "white", 0.5, 0.65, "center", "middle") );
    this.uiItems.push( new uiItemText("Credits", "32px", "MenuFont", "white", 0.5, 0.75, "center", "middle") );
